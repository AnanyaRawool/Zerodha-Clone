import React, {useState, useEffect} from "react"; //usestate ti store data coming from db , useeffect for to connect to api
...
// }
    ...
    <>
      ...
      <div className="order-table">
        ...
        {allHoldings.map((stock, index) => { // all logic is within map function
            ...
            return(
              <tr key={index}>
                 <td>{stock.name}</td>
                 <td>{stock.qty}</td>
                 <td>{stock.avg.toFixed(2)}</td>  {/*// it will give 2 deciaml places */}
